...
SEGMENTS: list[dict[str, str | float]] = [
    {
        "id": "01",
        "text": "应届生的春招，本质上是一场只有一次的赌博。你投出 60 份简历，70% 没有回音。你不知道 HR 怎么评价你，不知道公司隐性门槛有多深，也不知道选哪个 offer 三年后不后悔。",
        "duration_s": 18,
    },
    {
        "id": "02",
        "text": "我们做了一个产品——春招平行宇宙。它不是简历优化器，不是面试模拟器，也不是 JD 匹配工具。它做的事情很简单：让 AI 替你跑完整个春招的 1000 次平行宇宙，看完结论再决定你怎么投递。",
        "duration_s": 20,
    },
    {
        "id": "03",
        "text": "第一步，上传你的简历、GitHub、还有任何能体现你风格的文字。AI 不微调任何模型——它做的是 RAG，把你的资料拆成段落、建立向量索引，让 AI 化身随时能以你的视角做决策。选 RAG 不选 LoRA，是因为我们的沙盘是动态市场，公司和求职者随时加入退出，微调出来的模型一天就过期，而 RAG 永远拿到最新信息。",
        "duration_s": 47,
    },
    {
        "id": "04",
    ...
    {
        "id": "05",
        "text": "1000 次平行春招跑完，结果摆在你面前。你最可能的去向是焰火、深原、智索三家之一，平均拿到 5 到 6 个 offer，中位薪资 49 万。这不是建议，是 1000 个平行宇宙的统计结论。你还能看到全市场的画像——当前 49 家公司提供 96 个 JD，吸引 200 名求职者，平均招聘门槛 82 分，市场偏挑剔。",
        "duration_s": 60,
    },
    {
        "id": "06",
        "text": "这是别的 AI 求职工具做不到的：反事实预演。调一下滑动条——项目含金量再做扎实 15 分，平均薪资从 49 万涨到 64 万。简历质量降 20 分，offer 率掉到 76%。AI 不是给你建议，是统计意义上的后悔药。你能看到每个改动的真实代价和收益，然后再决定要不要去打磨那个项目。",
        "duration_s": 55,
    },
    {
        "id": "07",
